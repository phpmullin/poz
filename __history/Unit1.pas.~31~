...
uses
  ...
  cxDBLookupEdit, cxDBLookupComboBox, cxSpinEdit, cxTimeEdit;
...
procedure TAddUser.sMaskEdit1Change(Sender: TObject);
begin
...
begin
try
    ShowMessage('Не правильно ввели номер телефона');
except
